...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="{{ asset('lib/metisMenu/metisMenu.css') }}" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{{ asset('css/sb-admin-2.min.css') }}" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="{{ asset('lib/morrisjs/morris.css') }}" rel="stylesheet">
...
<script src="{{ asset('lib/morrisjs/morris.min.js') }}"></script>
